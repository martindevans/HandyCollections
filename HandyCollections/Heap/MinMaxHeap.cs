...
//        #region heapify
//        /// <summary>
//        /// Update the position of the item at the given index
//        /// </summary>
...
//            while (true)
//            {
//                int grandparentIndex = Parent(Parent(index));
//                if (grandparentIndex < 0)
//                    break;

//                T grandparentValue = _heap[grandparentIndex];
//                if (IsLessThan(grandparentValue, _heap[index]))
...
//                T grandparentValue = _heap[grandparentIndex];
//                if (IsGreaterThan(grandparentValue, _heap[index]))
//                    Swap(index, grandparentIndex);
...
//            //int level = (int)Math.Log(index + 1, 2.0);
//            //return (level % 2) == 0;
//        }
